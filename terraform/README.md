...
| source_image | The image name for the disk for the VM instance. | `string` | `"projects/click-to-deploy-images/global/images/jenkins-v20241201"` | no |
| zone | The zone for the solution to be deployed. | `string` | `null` | yes |
| machine_type | The machine type to create, e.g. e2-small | `string` | `"e2-standard-2"` | no |
...
| enable_compute_api | Allow read write access to Google Compute Engine APIs on the VM | `bool` | `true` | no |
